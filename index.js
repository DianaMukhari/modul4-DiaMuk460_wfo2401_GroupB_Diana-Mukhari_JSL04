...
let preferredVariety = userPreference === 'Sugar-free' ? 'Sugar-free' : 'Regular';

console.log(`User prefers ${preferredVariety} variety.`);
...
let massage = currentTemp <= 5 ? "Chilled to perfection!" : "Needs a cooler!";
console.log(massage);
...
let mesage = currentHour >= 7 && currentHour < 24 ? "Unleash the beast!" : "Better stick to water.";
console.log(mesage);
